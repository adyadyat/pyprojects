products_file = open("new_products.txt", encoding="koi8-r")
products = products_file.read()

new_products_file = open("products.txt", "a", encoding="cp1251")
...
РАЗНЫЕ КОДИРОВКИ
Рядом с программой находятся два файла: 
products.txt и new_products.txt.
Первый сохранен в кодировке cp1251, а второй в koi8-r.

Напишите программу, которая копирует список продуктов 
из файла new_products.txt в products.txt.
Все товары в  исходных файлах записаны с новой строки, 
